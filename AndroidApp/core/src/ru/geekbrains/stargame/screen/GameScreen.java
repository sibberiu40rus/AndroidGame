...
public class GameScreen extends Base2dScreen {
    ...
    public void show() {
        ...
        mainShip = new MainShip(atlas,exposionPool, bulletPool, laserSound);
    ...
    public void printInfo() {
        ...
        font.draw(batch,sbLevel.append(LEVEL).append(enemiesEmitter.getLevel()), worldBounds.getRight() - 2f , worldBounds.getTop()-2f, Align.right);
    }
